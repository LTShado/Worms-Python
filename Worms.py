...
while launched:
    ...
    pygame.draw.line(surface, traj_color, [playerOne.body.centerx, playerOne.body.centery],[x_souris, y_souris])
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            pygame.draw.line(surface, traj_color, [playerOne.body.centerx, playerOne.body.centery], [event.pos[0],event.pos[1]])
            playerOne.draw()
            pygame.draw.rect(surface, ground_color, collide)
